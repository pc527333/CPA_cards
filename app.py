...
font_size_1 = col2.slider("Name font size:", min_value=10.0, max_value=15.0, value=12.0, step = 0.1)
...
def create_pdfs(file_dict, text_size, section_text_size, header_fontsize):
    ...
    font_path_1 = 'MavenPro-ExtraBold.ttf'
    font_path_2 = 'MavenPro-Bold.ttf'
    font_path_3 = 'MavenPro-Medium.ttf'
    font_path_4 = 'MavenPro-Regular.ttf'
        ...
        try:
            ...
            for i, r in data_df.iterrows():
                ...
                try:
                    ...
                    x = 9
                    color = (0, 0, 0) # (0.0627451, 0.18039216, 0.2627451) #

                    insert_text_(name, x, 71, font_path_1, 'font2', font_size_1, color = color, ) #  (0.0627451, 0.18039216, 0.2627451)
                    insert_text_(r["Title"], x, 84, font_path_3, 'font3', font_size_2, color = color, )

                    insert_text_(r["Info field 1"], x, 113, font_path_4, 'font4', font_size_3, color = color, )
                    insert_text_(r["Info field 2"], x, 123, font_path_4, 'font4', font_size_3, color = color, )
                    insert_text_(r["Info field 3"], x, 133, font_path_4, 'font4', font_size_3, color = color, )
